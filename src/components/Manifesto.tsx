...
const LINES = [
  ...
  { t: 'Gravamos sobre o corpo', italic: false, d: 0.18 },
  { t: 'aquilo que o tempo respeita —', italic: true, d: 0.27 },
  { t: 'a linha, o ponto,', italic: false, d: 0.36 },
...
const PILLARS = [
  ...
  },
  {
    gr: 'ΣΤΙΓΜΗ',
    title: 'O Ponto',
    body: 'O pontilhismo mede o tempo. Mil estigmas formam a sombra — paciência que vira profundidade.',
  },
  {
    gr: 'ΣΙΩΠΗ',
    title: 'O Silêncio',
    body: 'O vazio é tão expressivo quanto a tinta. O que não se grava define o que permanece.',
  },
];
...
export default function Manifesto() {
  return (
    <section
      id="manifesto"
      className="dots relative z-10 px-7 py-36 sm:px-12 lg:py-44"
    >
      <div className="mx-auto max-w-6xl">
        <Reveal>
          <p className="mb-20 font-sans text-[10px] uppercase tracking-[0.55em] text-gold/60">
            i — manifesto
          </p>
        </Reveal>
          ...
          {PILLARS.map((p, i) => (
            <Reveal key={p.title} delay={i * 0.09}>
              <div className="flex flex-col gap-4 py-10 sm:border-l sm:border-bone/10 sm:px-10 sm:first:border-l-0 sm:first:pl-0">
                <span className="font-sans text-[10px] uppercase tracking-[0.45em] text-gold/60">
                  {p.gr}
                </span>
